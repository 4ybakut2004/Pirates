...
function level_2_inf()
{
	if(level_2_vis)
	{
		...
		distance_new = distance;
		document.getElementById("bal").innerHTML = "0";
		document.getElementById("p8").innerHTML = "Берегись! этот уровень коварен и опасен. У тебя будет не так много времени, чтобы собрать нужное количество бомб, которые пригодятся тебе на третьем уровне! Остерегайся рифов и птиц! И собирай как можно больше рыбок, они увеличат количество твоих бобм!";
